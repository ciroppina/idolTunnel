 ...
 * generated in the it.skymedia.idolTunnel.ws package. 
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: it.skymedia.idolTunnel.ws
     * 
     */
